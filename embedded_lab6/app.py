import csv  #game saves player results in CSV format
import os #used for create folder
import queue #Used to safely store incoming serial messages from Arduino
import threading
import time
import tkinter as tk #Main Python GUI library
...
#This class saves and loads player results
class PlayerData:
    @staticmethod
    def safe_name(name):
        
        clean = "".join(c for c in name if c.isalnum() or c in ("-", "_", " ")).strip()
        #Keeps only letters, numbers, dash, underscore, and space
        return clean or "unnamed"
        #If name becomes empty, use "unnamed"
...
class ReactionGameApp:
    ...
    def __init__(self, root):
        ...
        #Initial game state and counters
